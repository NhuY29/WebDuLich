    ...
    <div class="main">
        ...
        <div class="main-dropdown">
            <div class="menu-dropdown goout">
                ...
                <div class="menu-dropdown-item">
                    <ul class="upberator-dropdown">
                        <li class="list-dropdown lisdp"> <B><a href="./Mien Tay.html.html">TOUR MIỀN TÂY NAM BỘ </a></B>
                        </li>
                ...
                <div class="menu-dropdown-item">
                    <ul class="upberator-dropdown">
                        <li class="list-dropdown lisdp"> <B><a href="./Mien Dong.html.html">TOUR MIỀN ĐÔNG NAM BỘ
                                </a></B>
                        </li>
        ...
        <div class="main-dropdown2">
            <div class="menu-dropdown2">
                <ul class="uperator-dropdown2">
                    <li class="list-dropdown2"> <a href="./KhuyenMai1.html">Vietravel & Sacombank tung ưu đãi “Tiền về
                            đầy ví - Du hí thả
                            ga” </a> </li>
                    <li class="list-dropdown2"> <a href="./KhuyenMai2.html"> Vietravel & JCB tung ưu đãi “Thanh toán
                            liền tay - Nhận ngay
                            deal xịn”</a></li>
                    <li class="list-dropdown2"> <a href="./KhuyenMai3.html"> Vietravel triển khai chương trình ưu đãi
                            cùng VNPAY “Trúng
                            deal to – Du lịch chẳng lo”</a></li>
                    <li class="list-dropdown2"> <a href="./KhuyenMai4.html"> Vietravel & Sacombank: Quẹt thẻ liền tay -
                            Giảm ngay 1 triệu
                            đồng</a></li>
                </ul>
                <i class="fa-solid fa-xmark iconclosed" onclick="closeddmenu()"></i>
        ...
        <div class="content">
            <div class="left testhu" onclick="closedmenu()">
                <div>
                ...
                <div>
                    ...
                    <select id="" name="Điểm Đến">
                        ...
                        <option selected="" value="3">Hà Nội</option>
            ...
            <div class="right testhu">
                <h1 class="darkh1">Du lịch Hà Nội</h1>
                <hr>
                <p>Hà Nội là thủ đô ngàn năm văn hiến, còn lưu dấu nhiều di tích như Hồ Gươm, Cầu Thê Húc, Chùa Quán Sứ,
                    Hồ Tây, 36 phố phường. Hà Nội có bốn mùa, luôn mang đến nhiều hoài niệm khó phai, mỗi mùa một vẻ,
                    xuân lễ hội, hạ tươi thắm, thu quyến rũ và đông ấn tượng. Món ngon có Phở, Chả cá Lã Vọng, bánh tôm
                    Hồ Tây.</p>
                <p>Đăng ký tour Hà Nội cùng Vietravel, Quý khách có thể đến khám phá các điểm đến nổi bật sau: Hồ Hoàn
                    Kiếm, Đền Ngọc Sơn, Văn Miếu, Chùa Trấn Quốc, Lăng Hồ Chủ Tịch, Bảo tàng Hồ Chí Minh, Nhà Sàn Bác
                    Hồ, Chùa Một Cột, Hoàng Thành Thăng Long, Cầu Thê Húc, Vườn Quốc Gia Ba Vì, Làng Cổ Đường Lâm, Chùa
                    Hương,</p>
                <p>Để hiểu hơn về Hà Nội Mời Quý khách tham khảo Kinh nghiệm du lịch Hà Nội</p>

                <div class="first">
                    <div class="Tour1">
                        <img src="./img/HN1.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">29/6/2023-4N3D-Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Hà Nội - Bái Đính - Khu Du Lịch
                                        Tràng An - Bái Đính - Hạ Long - Yên Tử</B></a>
                            </div>
                            <div class="Phan2">
                    ...
                    <div class="Tour2">
                        <img src="./img/HN2.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">28/8/2023-4N3D-Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Hà Nội - Vịnh Hạ Long - SaPa- Bản
                                        Cát Cát- FanSiPan</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/HN4.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/6/2023-3N2D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Cần Thơ - Hà Nội - Hạ Long - Động
                                        Thiên Cung - Bái Đính(Khách sạn 3 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDCTH1061-021-170623VN-V</p>
                    ...
                    <div class="Tour5">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">28/5/2023-3N2D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Hà Nội - Vịnh Hạ Long - Chùa Bái
                                        Đính - Tràng An (Khách sạn 5 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                    ...
                    <div class="Tour6">
                        <img src="./img/HN6.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">1/6/2023-3N2D-Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Cần Thơ - Hà Nội - Sapa - Đỉnh
                                        Fansipan - Hạ Long - Bái Đính (Khách sạn 4 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDCTH122-024-270623VN-V</p>
                                <p>Nơi Khởi Hành: <b>Cần Thơ</b></p>
                                <p><b style="color: #FD5056;">10,000,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
