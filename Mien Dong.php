...
<link rel="stylesheet" href="./filejava/start.js">
    ...
    <title>Du Lịch Miền Đông Nam Bộ</title>
</head>
...
<!-- toiday -->
            ...
            <div class="right testhu">
                ...
                <hr>
                <p>Đông Nam bộ bao gồm tứ giác kinh tế Tp. HCM - Bình Dương - Đồng Nai và Bà Rịa - Vũng Tàu, cùng với Bình Phước, Tây Ninh. Du lịch miền Đông có sức hút mạnh mẽ nhờ điểm đến hấp dẫn, năng động và văn hóa độc đáo.</p>
                <p>Để hiểu hơn về Miền Đông Nam Bộ Mời Quý khách tham khảo Kinh nghiệm du lịch Miền Đông Nam Bộ</p>
                ...
                <div class="first">
                    <div class="Tour1">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">30/07/2023 - Trong ngày - Giờ đi: 05:30</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Tây Ninh - Hành trình chinh phục nóc nhà Nam Bộ - Tặng vé tham quan 3 tuyến cáp treo Chùa Hang - Tâm An</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN870-012-300423XE-V</p>
                    ...
                    <div class="Tour2">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">02/05/2023 - Trong ngày - Giờ đi: 16:05</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Free Walking Tour - Ký Ức Sài Gòn Xưa</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    DSSGN820-004-020523-FWT</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">0₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                    ...
                    <div class="Tour3">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">14/05/2023 - Trong ngày - Giờ đi: 08:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Củ Chi - Nông Trang Xanh - Địa Đạo vùng Đất Thép</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    DSSGN865-007-140523XE-02</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">699,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/MD4.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">10/05/2023 - 3N2Đ - Giờ đi: 00:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Côn Đảo - Thiên Đường Của Biển</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN821-002-100523VN-D</p>
                                <p>Nơi Khởi Hành: <b> TP. Hồ Chí Minh</b></p>
                    ...
                    <div class="Tour5">
                        <img src="./img/MD5.png" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">14/05/2023 - Trong ngày - Giờ đi: 16:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Sài Gòn đẹp lắm! Trải nghiệm xe buýt hai tầng - Xuôi dòng Bình Trị Giang</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    DSSGN819-007-140523XE-V-F</p>
                                <p>Nơi Khởi Hành: <b>Đà Nẵng</b></p>
                                <p><b style="color: #FD5056;">990,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                    ...
                    <div class="Tour6">
                        <img src="./img/MD6.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">21/05/2023 - Trong ngày - Giờ đi: 05:30</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Hành trình xanh Cần Giờ - Vàm Sát</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    DSSGN829-007-210523XE-V-F</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">1,690,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
