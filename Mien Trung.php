    ...
    <input type="checkbox" name="" id="" class="chekboxxxx">
        ...
        <div class="content">
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Du lịch Miền Trung</h1>
                <hr>
                <p>Miền Trung Việt Nam gồm Bắc Trung Bộ, Nam Trung Bộ và Tây Nguyên, tổng 19 tỉnh thành. Miền Trung là giao điểm của sông núi hữu tình, thiên nhiên hùng vĩ, văn hóa đặc sắc, pha trộn ảnh hưởng của Hindu và Trung Hoa. Một điểm đến lý tưởng!</p>
                <p>Để hiểu hơn về Miền Trung Mời Quý khách tham khảo Kinh nghiệm du lịch Miền Trung</p>

                <div class="first">
                    <div class="Tour1">
                        <img src="./img/MT1.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/10/2023 - 2N1Đ - Giờ đi: 10:10</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Bắc Trung Bộ: Sầm Sơn (Thanh Hóa) - Cửa Lò (Nghệ An) - Nhật Lệ (Quảng Bình) - Cửa Tùng (Quảng Trị)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN3398-060-040523VU</p>
                    ...
                    <div class="Tour2">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">25/09/2023 - 3N2Đ - Giờ đi: 05:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Nam Trung Bộ: Bãi biển Đà Nẵng - Cù lao Chàm (Quảng Nam) - Bãi biển Sa Huỳnh (Quảng Ngãi)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN523-010-290423XE-V</p>
                    ...
                    <div class="Tour3">
                        <img src="./img/MT3.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">11/08/2023 - 4N3Đ - Giờ đi: 09:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Tây Nguyên: Huyền thoại hồ Lắk - Hang động Chư Bluk - Cột mốc biên giới Campuchia – Lào – Việt Nam</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN612-021-300423XE-V</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/MT4.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">09/06/2023 - 2N3Đ - Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Tây Nguyên: Núi Langbiang - Khu bảo tồn thiên nhiên Tà Đùng - Thung lũng Tình Yêu</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN111-001-300423VN-1</p>
                                <p>Nơi Khởi Hành: <b>Đà Nẵng</b></p>
                                <p><b style="color: #FD5056;">5,390,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.php">Xem chi tiết</a></button>
                    ...
                    <div class="Tour5">
                        <img src="./img/MT5.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">10/10/2023 - 4N3Đ - Giờ đi: 04:10</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Cầu Vàng - Mũi Né (Bình Thuận) - Bãi biển Quy Nhơn (Khách sạn 4 & 5 Sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDLUXSGN510-002-0405</p>
                                <p>Nơi Khởi Hành: <b>Đà Nẵng</b></p>
                                <p><b style="color: #FD5056;">11,590,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.php">Xem chi tiết</a></button>
                    ...
                    <div class="Tour6">
                        ...
                        <div>
                            <div class="Phan1">
                                ...
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đà Nẵng – KDL Bà Nà – Sơn Trà – Hội An – La Vang - Động Phong Nha – Làng hương Thủy Xuân - Huế</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN111-001-300423VN-1</p>
