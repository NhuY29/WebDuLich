        ...
        <div class="main-dropdown2">
            <div class="menu-dropdown2">
                <ul class="uperator-dropdown2">
                    <li class="list-dropdown2"> <a href="./KhuyenMai1.php">Vietravel & Sacombank tung ưu đãi “Tiền về
                            đầy ví - Du hí thả
                            ga” </a> </li>
                    <li class="list-dropdown2"> <a href="./KhuyenMai2.php"> Vietravel & JCB tung ưu đãi “Thanh toán liền
                            tay - Nhận ngay
                            deal xịn”</a></li>
                    <li class="list-dropdown2"> <a href="./KhuyenMai3.php"> Vietravel triển khai chương trình ưu đãi
                            cùng VNPAY “Trúng
                            deal to – Du lịch chẳng lo”</a></li>
                    <li class="list-dropdown2"> <a href="./KhuyenMai4.php"> Vietravel & Sacombank: Quẹt thẻ liền tay -
                            Giảm ngay 1 triệu
                            đồng</a></li>
                </ul>
                <i class="fa-solid fa-xmark iconclosed" onclick="closeddmenu()"></i>
            ...
            <div class="LienHeForm">
                ...
                <div class="LienHe-left ">
                    ...
                    <div class="Dongthu1">
                        ...
                        <div class="cach">
                            ...
                            <input type="text1" minlength="1" maxlength="30" required name="Email">
                        </div>
                    </div>
                    ...
                    <div class="Dongthu2">
                        <div class="cach5">
                            ...
                            <input type="tel" pattern="[0-9]{10}" required name="dt">
                        </div>
                        <div class="cach2">
                    ...
                    <button type="submit" name="btns" class=" btn-submit-LH">Gửi Đi <i
                ...
                <div class="LienHe-right">
                    ...
                    <div class="thanhtruot">
                        ...
                        <p><i class="fa-solid fa-map"></i> 190 Pasteur, P. Võ Thị Sáu, Q.3, Tp. Hồ Chí Minh, Việt Nam
                        </p>
                        <p><i class="fa-solid fa-phone"></i>Tel: (84-28) 38 668 999 (20 lines)</p>
                        <p><i class="fa-solid fa-fax"></i> Fax: (84-28) 38 29 9142</p>
                        <p><i class="fa-solid fa-envelope"></i>Email: info@vietravel.com - info.asia@vietravel.com
                            (English
                            Support)</p>
                        ...
                        <p><i class="fa-solid fa-map"></i>90A Nguyễn Thị Minh Khai, P. Võ Thị Sáu, Quận 3, Tp.HCM, Việt
                            Nam
                        </p>
                        <p><i class="fa-solid fa-phone"></i> Tel: (84-28) 3822 7755 / Đặt vé máy bay: 0938 301 377 /
                            Khách
                            hợp
                            đồng: 0938 798 866</p>
                        ...
                        <p><i class="fa-solid fa-map"></i> Văn phòng Tầng lửng Ga đi quốc nội - Sân bay Tân Sơn Nhất (P.
                            2,
                            Q. Tân Bình, TP. HCM) </p>
                        ...
                        <p><i class="fa-solid fa-map"></i> VPDL khách lẻ: 03 Hai Bà Trưng, Hà Nội - Tel: 024. 3933 1978
                            |
                            VPDL khách đoàn: Tầng 7, tòa nhà Hồng Hà - Số 37 Ngô Quyền, Hà Nội - Tel: 024. 3971 1159
                        </p>
                        <p><i class="fa-solid fa-phone"></i> Tel: (84.24) 3933 1978 | Hotline: DLTN - 0989 37 00 33 /
                            DLNN -
                            0983 16 00 22</p>
                        ...
                        <p><i class="fa-solid fa-envelope"></i>Email: vtv.haiphong@vietravel.com; info.hph@vietravel.com
                        </p>


                        <p style="font-size: 20px; "><b>Miền Trung</b></p>
                        <p style="font-size: 18px; "><b>CHI NHÁNH HUẾ</b></p>
                        <p><i class="fa-solid fa-map"></i> Số 03 Hùng Vương, Phường Phú Hội, Tp. Huế, tỉnh Thừa Thiên
                            Huế
                        </p>
                        ...
                        <p><i class="fa-solid fa-phone"></i>Tel: (84.262) 3753 999 - Ext: 4607 | Hotline: 0906 50 90 95
                        </p>
