    ...
    <input type="checkbox" name="" id="" class="chekboxxxx">
        ...
        <div class="content">
            <div class="left testhu">
                ...
                <div>
                    ...
                    <select name="Điểm Đến">
                        ...
                        <option selected=""  value="54">Phú Quốc</option>
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Du lịch Phú Quốc</h1>
                <hr>
                <p>Phú Quốc là điểm nghỉ dưỡng, tham quan, và khám phá sinh thái tuyệt vời. Mũi Ông Đội, Đá Chào là thế giới san hô và cá biển sặc sỡ. Bãi Sao cát trắng mịn, dáng cong, nước xanh ngọc bích. Đặc sản danh tiếng cả nước là tiêu sọ, nước mắm, rượu sim, ngọc trai. Phú Quốc thực sự là một viên ngọc quý trên bản đồ Việt Nam.</p>
                <p>Đăng ký tour Phú Quốc cùng Vietravel, Quý khách có thể đến khám phá các điểm đến nổi bật sau: DINH CẬU - DINH BÀ THỦY LONG THÁNH MẪU, BÃI SAO, Long Beach Pearl Phú Quốc, THIỀN VIỆN TRÚC LÂM HỘ QUỐC, VinWonders Phú Quốc, Grand World Phú Quốc, INK 360, Sunset Sanato Beach Club, Nghề làm nước mắm, Vin Safari, Ngắm hoàng hôn, HÒN THƠM - CÁP TREO, BÃI SAO 1, TOUR 4-5 ĐẢO, TOUR 4-5 ĐẢO (1), TOUR 4-5 ĐẢO - HÒN GẦM GHÌ, BÃI SAO 3, HÒN THƠM - CÔNG VIÊN NƯỚC AQUATOPIA, HÒN THƠM - QUẢNG TRƯỜNG LA MÃ, SARITA, DINH CẬU (1), CHỢ ĐÊM PHÚ QUỐC, PHỦ THỜ QUAN THÁNH ĐẾ QUÂN, THÁNH THẤT CAO ĐÀI (PHÚ QUỐC)</p>
                <p>Để hiểu hơn về Phú Quốc Mời Quý khách tham khảo Kinh nghiệm du lịch Phú Quốc</p>
                <div class="first">
                    <div class="Tour1">
                        <img src="./img/PQ1.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">06/07/2023 - 2N1Đ - Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc - Trải nghiệm chèo Sup - Đạp xe tại Rạch Vẹm hoang sơ - Cắm trại đêm - BBQ tối</a></B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDPQC001-019-060523</p>
                                <p>Nơi Khởi Hành: <b>Phú Quốc</b></p>
                                <p><b style="color: #FD5056;">2,799,000₫</b></p>
                            </div>
                    ...
                    <div class="Tour2">
                        <img src="./img/PQ2.webp" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">04/05/2023 - 4N3Đ - Giờ đi: 17:45</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc - Kỳ Nghỉ Đẳng Cấp Tại Thiên Đường Biển Đảo (Trải Nghiệm Hạng Thương Gia, Du Thuyền Catamaran Sarita 5 sao)</a></B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDLUXSGN800-006-06</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">35,990,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.php">Xem chi tiết</a></button>
                    ...
                    <div class="Tour3">
                        <img src="./img/PQ3.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">11/8/2023 - 3N2Đ - Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc: Hòn Thơm Nature Park (Tặng Vé Cáp Treo 3 Dây Vượt Biển Dài Nhất Thế Giới, Khách Sạn 3 Sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN855-065-050523VU-V</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">4,790,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.php">Xem chi tiết</a></button>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/PQ4.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">29/09/2023 - 3N2Đ - Giờ đi: 17:05</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc: Thử tài câu cá - Tham quan thành phố không ngủ Grand World - Tắm biển Bãi Sao (Khách sạn 3 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN817-032-290423VU-O</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">5,990,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.php">Xem chi tiết</a></button>
                    ...
                    <div class="Tour5">
                        <img src="./img/PQ5.webp" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">10/12/2023 - 3N2Đ - Giờ đi: 17:45</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc - Thiên đường giải trí VinWonders - Vinpearl Safari - Hòn Thơm Nature Park</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN856-001-020523QH-V</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">7,990,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.php">Xem chi tiết</a></button>
                    ...
                    <div class="Tour6">
                        <img src="./img/PQ6.webp" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">29/06/2023 - 3N2Đ - Giờ đi: 15:05</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc : Charter bay thẳng từ Buôn Ma Thuột - Thị trấn Hoàng Hôn - Vinwonders & Safari (Khách sạn 4 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDDLA878-001-290423VN</p>
                                <p>Nơi Khởi Hành: <b>Buôn Ma Thuột</b></p>
