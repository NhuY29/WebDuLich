...
<link rel="stylesheet" href="./filejava/jquery-3.6.4.min.map">
    
    <title>Du Lịch Hải Phòng</title>
</head>
<!-- oc sen -->
        ...
        <div class="content">
            <div class="left testhu">
                ...
                <div>
                   ...
                   <select name="Điểm Đến"><option value="0">--Chọn điểm đến--</option><option value="99">An Giang</option><option value="53">Bà Rịa - Vũng Tàu</option><option value="130">Bắc Kạn</option><option value="206">Bạc Liêu</option><option value="33">Bắc Ninh</option><option value="188">Bến Tre</option><option value="94">Bình Định</option><option value="367">Bình Dương</option><option value="369">Bình Phước</option><option value="194">Bình Thuận</option><option value="47">Buôn Ma Thuột</option><option value="137">Cà Mau</option><option value="56">Cần Thơ</option><option value="129">Cao Bằng</option><option value="192">Côn Đảo</option><option value="45">Đà Lạt</option><option value="42">Đà Nẵng</option><option value="341">Đắk Nông</option><option value="187">Điện Biên</option><option value="52">Đồng Nai</option><option value="199">Đồng Tháp</option><option value="108">Nghệ An</option><option value="135">Hà Giang</option><option value="32">Hạ Long</option><option value="361">Hà Nam</option><option value="29">Hà Nội</option><option value="59">HÀ TIÊN</option><option value="195">Hà Tĩnh</option><option selected="" value="30">Hải Phòng</option><option value="363">Hòa Bình</option><option value="380">HÒN SƠN</option><option value="39">Huế</option><option value="193">Kiên Giang</option><option value="48">Kon Tum</option><option value="37">Lạng Sơn</option><option value="38">Lào Cai</option><option value="214">Long An</option><option value="232">Nam Định</option><option value="44">Nha Trang</option><option value="35">Ninh Bình</option><option value="106">Ninh Thuận</option><option value="49">Pleiku</option><option value="51">Phan Thiết</option><option value="54">Phú Quốc</option><option value="34">Phú Thọ</option><option value="121">Phú Yên</option><option value="41">Quảng Bình</option><option value="198">Quảng Ngãi</option><option value="43">Quảng Nam</option><option value="196">Quảng Ninh</option><option value="40">Quảng Trị</option><option value="141">Quy Nhơn</option><option value="58">Sóc Trăng</option><option value="134">Sơn La</option><option value="203">Tây Ninh</option><option value="55">Tiền Giang</option><option value="197">TP. Hồ Chí Minh</option><option value="213">Trà Vinh</option><option value="377">Tuyên Quang</option><option value="233">Thái Bình</option><option value="133">Thanh Hóa</option><option value="57">Vĩnh Long</option><option value="202">Vĩnh Phúc</option><option value="231">Yên Bái</option></select>
                </div>
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Du lịch Hải Phòng</h1>
                <hr>
                <p>Thành phố biển Hải Phòng, một trong những trung tâm du lịch lớn của Việt Nam. Hải Phòng còn giữ được
                    nhiều di tích lịch sử, danh lam thắng cảnh và đặc biệt là lễ hội chọi trâu ở Đồ Sơn. Hải Phòng nằm
                    trong tuyến du lịch đặc sắc Hà Nội - Hải Phòng - vịnh Hạ Long. Từ biển Đồ Sơn, du khách có thể tới
                    thăm đảo và vườn quốc gia Cát Bà, thăm vịnh Bái Tử Long và vịnh Hạ Long.</p>
                <p>Đăng ký tour Hải Phòng cùng Vietravel, Quý khách có thể đến khám phá các điểm đến nổi bật sau: Đảo
                    Cát Bà, Vịnh Lan Hạ,</p>
                <p>Để hiểu hơn về Hải Phòng Mời Quý khách tham khảo Kinh nghiệm du lịch Hải Phòng</p>
                ...
                <div class="first">
                    <div class="Tour1">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">27/08/2023 - 4N3Đ - Giờ đi: 06:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đồ Sơn - Vạn Hương - Đồ Sơn - Hải
                                        Phòng (Khách sạn 5 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN169-001-140523VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">8,000,000₫</b></p>
                            </div>
                    ...
                    <div class="Tour2">
                        <img src="./img/Hp4.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/6/2023-2N1D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đảo Cát Bà - Vịnh Lan Hạ - Cát
                                        Hải - Hải Phòng </B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN169-005-110623VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">3,490,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                    ...
                    <div class="Tour3">
                        ...
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">16/08/2023 - 4N3Đ - Giờ đi: 08:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Tam Đảo - Thiền Viện Trúc Lâm Tây
                                        Thiên - Vườn Quốc Gia Cát Bà (Khách sạn 3 sao) </B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN169-006-180623VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">13,590,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/HP6.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/6/2023-3N2D-Giờ đi: 2:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Nhà hát thành phố - Tuyệt tình
                                        cốc - Đồ Sơn</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN169-010-160723VN-D</p>
                                <p>Nơi Khởi Hành: <b>Hải Dương</b></p>
                                <p><b style="color: #FD5056;">6,490,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                    ...
                    <div class="Tour5">
                        <img src="./img/HN2.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">1/6/2023-3N2D-Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đảo Bạch Long Vĩ - Tháp Tường
                                        Long - Biệt thự Bảo Đại (Khách sạn 5 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN103-047-170823VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">9,490,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                 <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                    ...
                    <div class="Tour6">
                        <img src="./img/HN5.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">1/6/2023-3N2D-Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đảo Hòn Dấu - Bến tàu không số
                                        K15 - Núi Voi (Khách Sạn 3 & 4 sao )</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN169-014-130823VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">12,000,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
