    ...
    <div class="main">
        ...
        <div class="content">
            <div class="left testhu">
                ...
                <div>
                    ...
                    <select name="Điểm Đến">
                        ...
                        <option selected="" value="39">Huế</option>
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Du lịch Huế</h1>
                <hr>
                <p>Huế thương sơn thủy hữu tình, nơi tọa lạc Đại Nội, Ngọ Môn, Điện Thái Hòa, Tử Cấm Thành, Lăng Tự Đức,
                    Thế Miếu, Hiển Lâm Các, Cửu Đỉnh xưa của 13 vị vua triều Nguyễn. Chùa Thiên Mụ lưu giữ cổ vật lịch
                    sử, nghệ thuật quý giá. Chiều buông, ta ngồi thuyền rồng xuôi dòng sông Hương thưởng thức ca hò Huế,
                    thả hoa đăng cầu phúc lộc.</p>
                <p>Đăng ký tour Huế cùng Vietravel, Quý khách có thể đến khám phá các điểm đến nổi bật sau: Đại Nội,
                    Chùa Thiên Mụ, Huế, Nhà vườn An Hiên, Lăng Tự Đức, Lăng Khải Định, Đầm Lập An,</p>
                <p>Để hiểu hơn về Huế Mời Quý khách tham khảo Kinh nghiệm du lịch Huế</p>

                <div class="first">
                    <div class="Tour1">
                        <img src="./img/hue6.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/05/2023 - 5N4Đ - Giờ đi: 07:10</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Huế - La Vang - Động Phong Nha &
                                        Thiên Đường - KDL Bà Nà - Cầu Vàng - Sơn Trà - Hội An - Đà Nẵng</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN3399-013-130523VN</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">8,590,000₫</b></p>
                            </div>
                    ...
                    <div class="Tour2">
                        <img src="./img/Hue1.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">05/09/2023 - 3N2Đ - Giờ đi: 05:45</p>
                                    <a href="" style="font-size: 16px; color: #2D4271;"><B>Đà Nẵng - Hội An - Bà Nà -
                                            Cầu Vàng - Huế - Trải nghiệm đi thuyền dạo Sông Hoài & Tặng show Ký Ức Hội
                                            An</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN322-004-050523VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                    ...
                    <div class="Tour3">
                        ...
                        <div>
                            <div class="Phan1">
                                ...
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Bao Vinh Ngày Về </B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDHUE129-008-070523XE</p>
                                <p>Nơi Khởi Hành: <b>Huế</b></p>
                                <p><b style="color: #FD5056;">500,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/hue3.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">06/05/2023 - 4N3Đ - Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đà Nẵng – KDL Bà Nà – Sơn Trà –
                                        Hội An – La Vang - Động Phong Nha – Làng hương Thủy Xuân - Huế</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN3318-013-060523VJ-V</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minhg</b></p>
                                <p><b style="color: #FD5056;">7,400,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
                    ...
                    <div class="Tour5">
                        <img src="./img/hue4.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">09/06/2023 - 4N3Đ - Giờ đi: 04:10</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đà Nẵng - Huế - Đầm Lập An - La
                                        Vang - Động Thiên Đường - KDL Bà Nà - Cầu Vàng - Hội An - Đà Nẵng (Khách sạn 4
                                        sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN3391-020-090523VU-V</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">3,500,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
                    ...
                    <div class="Tour6">
                        <img src="./img/hue5.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">07/07/2023 - 4N3Đ - Giờ đi: 07:10</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đà Nẵng - Huế - Đại Nội - Đầm Lập
                                        An - KDL Bà Na - Cầu Vàng - Sơn Trà - Phố cổ Hội An - Đà Nẵng </B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN3351-017-140523VU-F</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">5,000,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
