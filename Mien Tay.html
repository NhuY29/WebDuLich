...
<link rel="stylesheet" href="./filejava/start.js">
    ...
    <title>Du Lịch Miền Tây Nam Bộ</title>
</head>
    ...
    <div class="main">
        ...
        <div class="content">
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Miền Tây Nam Bộ</h1>
                <hr>
                <p>Du Lịch Miền Tây: Miền Tây Nam Bộ, vựa lúa lớn của cả nước, cây trái trĩu quả, cánh đồng thẳng cánh cò bay. Người dân đậm chất Nam Bộ, sống nhộn nhịp trên những chợ nổi Cái Bè, Cái Răng, Phụng Hiệp... Miền Tây, một không gian lắng tình người hồn hậu và tiếng ca tài tử đầy thi vị.</p>

                <div class="first">
                    <div class="Tour1">
                        <img src="./img/MTay1.webp" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">TP. Hồ Chí Minh</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Miền Tây - Mỹ Tho - Bến Tre - Cần Thơ ( Khách sạn 4 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN831-184-060523XE-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">1,990,000₫</b></p>
                            </div>
                    ...
                    <div class="Tour2">
                        <img src="./img/MTay2.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">06/07/2023 - 4N3Đ - Giờ đi: 05:30</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Miền Tây: Châu Đốc - Rừng Tràm Trà Sư - Hà Tiên - Rạch Giá - Cần Thơ (Khách sạn tương đương 3 sao & 4 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN847-044-060523XE-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">4,190,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                    ...
                    <div class="Tour3">
                        <img src="./img/MTay3.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">23/7/2023-2N1D-Giờ đi: 05:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Miền Tây: Cần Thơ - Sóc Trăng - Bạc Liêu - Cà Mau - Đất Mũi</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN844-058-060523XE-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">4,390,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/MTay4.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">08/05/2023 - 2N1Đ - Giờ đi: 05:30</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Miền Tây - Châu Đốc - Lâm Viên Núi Cấm - Miếu Bà Chúa Xứ - Rừng Tràm Trà Sư (Khách sạn 2 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN834-046-080523XE-G</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">TP. Hồ Chí Minh</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="./chitiet.html">Xem chi tiết</a></button>
