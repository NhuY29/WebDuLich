                ...
                <div class="header-above-menus">
                    ...
                    <div class="menu-left-div">
                        <ul class="menu-left ">
                            ...
                            <li class="list-menu" ><b > <a href="./LienHe.html">Liên Hệ</a>  </b></li>
                            <li class="list-menu"><b> <a href="./TravelPlus.html">VietTravelPlus</a> </b> </li>
                        </ul>
                    </div>
                        ...
                        <div class="first">
                            <div class="Tour1">
                                ...
                                <div class="phanthan">
                                    ...
                                    <div class="Phan3">
                                        <button class="Gia"><a href="./DatHang.html"><i class="fa-solid fa-cart-shopping"></i>Đặt
                                                Ngay</a></button>
