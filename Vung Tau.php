    ...
    <input type="checkbox" name="" id="" class="chekboxxxx">
        ...
        <div class="content">
            <div class="left testhu">
                ...
                <div>
                    ...
                    <select id="" name="Điểm Đến">
                        ...
                        <option selected="" value="16">Vũng Tàu</option>
                    </select>
                </div>
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Du lịch Bà Rịa -Vũng Tàu</h1>
                <hr>
                <p>Du lich Vũng Tàu: Những cung đường biển đẹp như mơ, ngọn Hải đăng cổ nổi tiếng, tượng Chúa giang tay bình yên, những góc phố thơ mộng, cùng những món ăn hấp dẫn là những gì du khách không thể bỏ qua khi đến với Vũng Tàu. Vũng Tàu trở thành đô thị loại I năm 2013, là một thành phố đáng tới, đáng sống và hạnh phúc.</p>
                <p>Đăng ký tour Bà Rịa - Vũng Tàu cùng Vietravel, Quý khách có thể đến khám phá các điểm đến nổi bật sau: Suối nước nóng Bình Châu, Bình Châu - Hồ Cốc, Vạn Phật Quang Đại Tòng Lâm Tự, Công viên rừng Minera Forest, CHÙA VẠN THÔNG, CHÙA VẠN THÔNG 1, THÀNH PHỐ VŨNG TÀU, BẢO TÀNG TỈNH BÀ RỊA - VŨNG TÀU</p>
                <p>Để hiểu hơn về Bà Rịa - Vũng Tàu Mời Quý khách tham khảo Kinh nghiệm du lịch Bà Rịa - Vũng Tàu</p>

                <div class="first">
                    <div class="Tour1">
                        <img src="./img/VT1.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">29/6/2023-4N3D-Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Núi Thị Vải - Núi Dinh - Tượng Chúa Kitô Vua</B></a>
                            </div>
                            <div class="Phan2">
                    ...
                    <div class="Tour2">
                        <img src="./img/VT3.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">28/8/2023-2N1D-Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Bãi biển Long Hải - Bãi biển Dinh Cô - Đèo Nước Ngọt</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN1331-010-290423VU</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">5,490,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="">Xem chi tiết</a></button>
                    ...
                    <div class="Tour3">
                        <img src="./img/VT4.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">23/7/2023-2N3D-Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Hồ Tràm - Khu bảo tồn thiên nhiên Bình Châu - Phước Bửu  </B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/VT5.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/6/2023-3N2D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Thị trấn Long Hải - Nhà Tròn Bà Rịa - Địa đạo Long Phước - Núi Dinh</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                    ...
                    <div class="Tour5">
                        <img src="./img/VT6.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">28/5/2023-3N2D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đồng cừu Suối Nghệ - Suối khoáng nóng Bình Châu - Hồ Cốc</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                    ...
                    <div class="Tour6">
                        <img src="./img/VT2.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">1/6/2023-3N2D-Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Chùa Bánh Xèo - Chùa Chén Kiểu - Côn Đảo (Khách Sạn 4 sao) </B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDCTH122-024-270623VN-V</p>
                                <p>Nơi Khởi Hành: <b>Cần Thơ</b></p>
                                <p><b style="color: #FD5056;">7,000,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt Ngay</button>
                                <button class="ChiTiet"><a href="">Xem chi tiết</a></button>
