...
<head>
    ...
    <link rel="stylesheet" href="./filecss/TravelPlus.css">
...
<body class="preloading">
    ...
    <input type="checkbox" name="" id="" class="chekboxxxx">
        ...
        <div class="content">
            <div class="head">
                <img src="./img/travelplus.jpg" alt="">
            </div>
            <div class="slg">
                <h1>Ưu đãi hấp dẫn trong tuần</h1>
            </div>
            <div class="UuDai">
                <div class="UuDai-Subitem">
                    <h2> <i class="fa-solid fa-gift"></i>Ưu Đãi Nổi Bật</h2>
                </div>
                <div class="UuDai-Subitem" style="background: linear-gradient(to right,#FF99CC,#FF99FF);">
                    <h2> <i class="fa-solid fa-gift"></i>Ưu Đãi Nổi Bật</h2>
                </div>
                <div class="UuDai-Subitem" style="background: linear-gradient(to right,#FF6347,#FF7F50);">
                    <h2> <i class="fa-solid fa-gift"></i>Ưu Đãi Nổi Bật</h2>
                </div>
            </div>
            <div class="slg2">
                <p>Vietravel <br> " Sự chuyên nghiệp mang lại cảm xúc thăng hoa <br>cho khách hàng và những giá trị gia
                    tăng
                    cho <br>khách sau mỗi chuyến đi."</p>
            </div>
            <div class="slg" style=" margin-top: 4%;">
                <h1>Hình ảnh khách đi tour</h1>
            </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <ul class="uberator-caroudel">
                            ...
                            <li><img src="./img/bn_230403_TourHongKong_1024-768px.webp" alt="New York" class="d-block">
                            </li>
                        </ul>
                    ...
                    <div class="carousel-item">
                        <ul class="uberator-caroudel">
                            <li> <img src="./img/khach1.jpg" alt="" class="d-block"></li>
                            <li> <img src="./img/khach2.jpg" alt="" class="d-block"></li>
                            <li><img src="./img/khach3.jpg" alt="" class="d-block"></li>
                            <ul>
                    </div>
                    <div class="carousel-item">
                        <ul class="uberator-caroudel">
                            <li> <img src="./img/khach4.jpg" alt="" class="d-block"></li>
                            <li> <img src="./img/khach5.jpg" alt="" class="d-block"></li>
                            <li><img src="./img/khach6.jpg" alt="" class="d-block"></li>
                            <ul>
                    </div>
                    <div class="carousel-item">
                        <ul class="uberator-caroudel">
                            <li> <img src="./img/khach7.jpeg" alt="" class="d-block"></li>
                            <li> <img src="./img/khach8.jpg" alt="" class="d-block"></li>
                            <li><img src="./img/khach9.png" alt="" class="d-block"></li>
                            <ul>
                    </div>
                </div>
            </div>
            <div class="slg">
                <h1>Đối tác của Vietravel</h1>
            </div>
            <div class="doi">
                <div class="img_doitac">
                    <div><img src="./img/doitac1.png" alt=""></div>
                    <div><img src="./img/doitac2.png" alt=""></div>
                    <div><img src="./img/doitac3.png" alt=""></div>
                    <div><img src="./img/doitaclogo.jpg" alt=""></div>
                </div>
            </div>
        </div>
    </div>
