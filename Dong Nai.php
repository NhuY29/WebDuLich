    ...
    <div class="main">
        ...
        <div class="content">
            <div class="left testhu">
                ...
                <div>
                    ...
                    <select name="Điểm Đến">
                        ...
                        <option selected="" value="52">Đồng Nai</option>
            ...
            <div class="right testhu">
                <h1 style="color: #2D4271; text-align: center;">Du lịch Đồng Nai</h1>
                <hr>
                <p>Đồng Nai là điểm đến picnic ngắn ngày lý tưởng với cụm đá Ba Chồng cao 36 mét kỳ thú, khu Bửu Long
                    quanh
                    hồ Long Ẩn, là một Vịnh Hạ Long thu nhỏ. Thác Giang Điền tung bọt trắng xóa, vườn quốc gia Cát Tiên
                    UNESCO công nhận là khu dự trữ sinh quyển của thế giới và thác Mai đầy hoa lan rừng, hoa mai, thủy
                    tiên.
                </p>
                <p>Đăng ký tour Đồng Nai cùng Vietravel, Quý khách có thể đến khám phá các điểm đến nổi bật sau: Vườn
                    Quốc
                    Gia Nam Cát Tiên, Ca Cao Trọng Đức, KDL CÁP TREO NÚI CHỨA CHAN, Làng Bưởi Tân Triều, Thảo Thiện
                    Garden,
                    SUỐI MƠ PARK, SUỐI MƠ PARK 1, SUỐI MƠ PARK 2, KDL CÁP TREO NÚI CHỨA CHAN 1, HOÀNG HÔN ĐẢO Ó - ĐÔNG
                    TRƯỜNG, KDL CAO MINH, ĐẢO Ó - ĐÔNG TRƯỜNG 1</p>
                <p>Để hiểu hơn về Đồng Nai Mời Quý khách tham khảo Kinh nghiệm du lịch Đồng Nai</p>
                ...
                <div class="first">
                    <div class="Tour1">
                        ...
                        <div>
                            <div class="Phan1">
                                ...
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Hồ Suối Vọng - Chùa Bạch Liên -
                                        Chùa
                                        Bạch Liên (Khách sạn 3 sao)</B></a>
                            </div>
                            <div class="Phan2">
                    ...
                    <div class="Tour2">
                        <img src="./img/DN2.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">28/8/2023-2N1D-Giờ đi: 07:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Vườn Quốc gia Nam Cát Tiên - Thác
                                        Giang Điền - Văn miếu Trấn Biên</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN1331-010-290423VF</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                    ...
                    <div class="Tour3">
                        <img src="./img/DN3.jpg" alt="">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">23/7/2023-3N2D-Giờ đi: 05:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Đá ba chồng - thác Đá Hàn - Khám
                                        phá
                                        “Vịnh Hạ Long” ở Đồng Nai (Khách sạn 5 sao)</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN397-001-090523-V-9</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">15,990,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
                ...
                <div class="second">
                    <div class="Tour4">
                        <img src="./img/DN4.webp" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">12/6/2023-3N2D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Núi Chứa Chan - Khu vui chơi Bò
                                        Cạp
                                        Vàng - Khu du lịch Bửu Long</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDCTH1061-021-170623VN-1</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">9,990,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
                    ...
                    <div class="Tour5">
                        <img src="./img/DN5.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">28/5/2023-3N2D-Giờ đi: 17:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Khu du lịch Tre Việt - Làng Bưởi
                                        Tân
                                        Triều - Vườn trái cây Long Khánh - Văn miếu Trấn Biên</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDSGN103-050-170823VN-D</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                    ...
                    <div class="Tour6">
                        <img src="./img/DN6.jpg" alt="" width="100%">
                        <div>
                            <div class="Phan1">
                                <p style="font-size: 12px;">1/6/2023-3N2D-Giờ đi: 15:00</p>
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Khu du lịch Bửu Long - Khu du
                                        lịch
                                        Vườn Xoài - Thiền viện Thường Chiếu - Công viên Suối Mơ</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                                    NDCTH122-024-270623VN-V</p>
                                <p>Nơi Khởi Hành: <b>TP. Hồ Chí Minh</b></p>
                                <p><b style="color: #FD5056;">10,100,000₫</b></p>
                            </div>
                            <div class="Phan3">
                                <button onclick="checkLogin()" class="Gia"><i class="fa-solid fa-cart-shopping"></i> Đặt
                                    Ngay</button>
