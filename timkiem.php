...
<head>
    ...
    <link rel="stylesheet" href="./filecss/timkiem.css">
    ...
    <input type="checkbox" name="" id="" class="chekboxxxx">
        ...
        <div class="content">
            ...
            <div class="right testhu">
                    ...
                    <div class="Tour3">
                        ...
                        <div>
                            <div class="Phan1">
                                ...
                                <a href="" style="font-size: 16px; color: #2D4271;"><B>Phú Quốc - Trải nghiệm chèo Sup - Đạp xe tại Rạch Vẹm hoang sơ - Cắm trại đêm - BBQ tối</B></a>
                            </div>
                            <div class="Phan2">
                                <p>Mã Tour: <i class="fa-solid fa-ticket" style="font-size: 16px;"></i>
                ...
                <div class="GT"><b>Các Tour Đang Tìm Kiếm Phổ Biến</b> </div>
                <div class="second2">
